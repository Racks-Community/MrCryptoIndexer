...
export interface Headwear {
  trait_type: "Headwear";
  value: HeadwearAttribute;
}

export interface Moustache {
  trait_type: "Moustache";
  value: MoustacheAttribute;
}
...
export enum MoustacheAttribute {
  Classic = "Classic",
